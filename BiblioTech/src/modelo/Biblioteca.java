...
public class Biblioteca implements Serializable {
	private static final String ERROR_CRÍTICO_AL_ACCEDER_AL_CATÁLOGO = "Error crítico al acceder al catálogo";
	...
	public void guardarEstado(String ruta) throws IOException {
		try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(ruta))) {
			...
			throw new IOException(ERROR_CRÍTICO_AL_ACCEDER_AL_CATÁLOGO); // Literal repetido
		}
	}
